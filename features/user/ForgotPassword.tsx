                ...
                <div className='py-24 px-10'>
...

                    {
                        ...
                        <>
                            ...
                            <div className='text-center mt-4'><Link href="/login"><button className="btn btn-block btn-primary ">Login</button></Link></div>
...

                    {
                        ...
                        <>
                            ...
                            <form onSubmit={(e) => submitForm(e)}>
                                ...
                                <div className='text-center mt-4'>Don't have an account yet? <Link href="/register"><button className="  inline-block  hover:text-primary hover:underline hover:cursor-pointer transition duration-200">Register</button></Link></div>
                            </form>
                        </>
                    }
