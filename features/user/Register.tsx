            ...
            <div className="card mx-auto w-full max-w-5xl  shadow-xl">
                ...
                <div className='py-24 px-10'>
                    ...
                    <form onSubmit={(e) => submitForm(e)}>
                        ...
                        <div className='text-center mt-4'>Already have an account? <Link href="/login"><span className="  inline-block  hover:text-primary hover:underline hover:cursor-pointer transition duration-200">Login</span></Link></div>
                    </form>
                </div>
            </div>
            </div>
